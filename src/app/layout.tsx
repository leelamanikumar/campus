          ...
          <header className="border-b border-white/10 bg-slate-950/80 px-6 py-4 backdrop-blur">
            <nav className="mx-auto flex w-full max-w-6xl items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="#contact"
                  className="rounded-full border-2 border-white/30 px-4 py-1.5 text-sm font-medium text-white transition hover:border-blue-500 hover:bg-blue-500 hover:font-bold"
                >
                  Contact
                </a>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="h-5 w-5 text-blue-400 transition hover:text-blue-300"
                  >
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="h-5 w-5 text-green-400 transition hover:text-green-300"
                  >
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="h-5 w-5 text-pink-500 transition hover:text-pink-400"
                  >
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="h-5 w-5 text-blue-500 transition hover:text-blue-400"
                  >
